...
interface AnalyticsPerDateTableProps {
  startDate: Date | null;
  endDate?: Date | null;
}

export default function AnalyticsPerDateTable({
  startDate,
  endDate,
}: AnalyticsPerDateTableProps) {
  ...
  const columns = useMemo<MRT_ColumnDef<AnalyticsPerDate>[]>(
    () => defaultColumns(),
    []
  );

  const defaultData = useMemo(() => [] as AnalyticsPerDate[], []);
