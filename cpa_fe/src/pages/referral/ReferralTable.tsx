...
import { Referral, getReferrals } from "@api/user/user";
...
export default function Referraltable() {
  ...
  const { data, isError, isFetching, isLoading, refetch } = useQuery({
    queryKey: ["referral", pagination.pageIndex, pagination.pageSize, user?.id],
    queryFn: async () => {
      const pageRequest = {
      ...
      return getReferrals(pageRequest, user?.id);
    },
  });
